...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "alphaserver@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "alphaserver API";

        private String description = "alphaserver API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "alphaserver";
